...
[NetDaemonApp]
public class SlaapkamerKen : AreaBase
{
    ...
    public SlaapkamerKen(IHaContext haContext, IScheduler scheduler, ILogger<SlaapkamerKen> logger,
    ...
    {
        light = _entities.Light.SlaapkamerKen;

        SubscribeToDeconzButton(Button.SlaapkamerKen);
        SubscribeToDeconzButton(Button.SlaapkamerKenBed);
    }
