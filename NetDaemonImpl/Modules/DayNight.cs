...
namespace NetDaemonImpl.Modules
{
    public class DayNight : IDayNight
    {
        ...
        private void Night(bool force)
        {
            ...
            if (Entities.Light.SfeerlampSpeelkamer.IsOn() || force)
            {
                LightControl.SetLight(Entities.Light.SfeerlampSpeelkamer, settingsProvider.BrightnessSfeerlampSpeelkamerNight);
            }
            WatchdogBuiten();
        }
        ...
        private void Day(bool force)
        {
            ...
            if (Entities.Light.SfeerlampSpeelkamer.IsOn() || force)
            {
                LightControl.SetLight(Entities.Light.SfeerlampSpeelkamer, settingsProvider.BrightnessSfeerlampSpeelkamerDay);
            }
            WatchdogBuiten();
        }
