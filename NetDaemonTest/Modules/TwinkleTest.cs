...
namespace NetDaemonTest.Modules
{
    public class TwinkleTest : ServiceProviderTestBase
    {
        ...
        public void TwinkleImpl_1CycleDay_VerifyResult()
        {
            ...
            lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.KeukenS1.EntityId), 1)).Returns(true);
            lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.KeukenS2.EntityId), 1)).Returns(true);
            lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.KeukenS3.EntityId), 1)).Returns(true);
            ...
            lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.KeukenS1.EntityId), 0)).Returns(false);
            //lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.KeukenS2.EntityId), 0)).Returns(false);
            lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.KeukenS3.EntityId), 0)).Returns(false);
