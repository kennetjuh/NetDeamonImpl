...
namespace NetDaemonTest.Modules
{
    public class DayNightTest : ServiceProviderTestBase
    {
        ...
        private void setupDayMocks(bool force, bool lightsOn)
        {
            ...
            haContextMock.Setup(x => x.GetState(entities.Light.SfeerlampSpeelkamer.EntityId)).Returns(new EntityState() { State = lightsOn ? "on" : "off" });
            ...
            if (lightsOn || force)
            {
                ...
                lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.SfeerlampSpeelkamer.EntityId), 51)).Returns(true);
        ...
        private void setupNightMocks(bool force, bool lightsOn)
        {
            ...
            if (lightsOn || force)
            {
                ...
                lightControlMock.Setup(x => x.SetLight(It.Is<LightEntity>(y => y.EntityId == entities.Light.SfeerlampSpeelkamer.EntityId), 11)).Returns(true);
